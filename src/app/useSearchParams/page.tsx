                ...
                {colorVariants.map((color) => (
                  <li key={color}>
                    <Link
                      ...
                      scroll={false}
                      className={cn([
                        "inline-block rounded-full border-2 border-gray-300 bg-gray-50 px-3 py-1 capitalize hover:bg-white",
                ...
                {sizeVariants.map((size) => (
                  <li key={size}>
                    <Link
                      ...
                      className={cn([
                        "inline-flex min-w-[5ch] justify-center rounded-full border-2 border-gray-300 bg-gray-50 px-3 py-1 uppercase hover:bg-white",
